...
import { Menu as MenuIcon, Search, Home as HomeIcon, User, Camera, MessageSquare, Loader2 } from 'lucide-react';
    ...
    <div className="relative h-[100dvh] w-full max-w-md mx-auto bg-[#f9f9f9] overflow-hidden flex flex-col font-sans">
      ...
      <div className="relative mt-auto h-[90px] w-full">
        ...
        <div className="absolute bottom-0 w-full h-[55px] flex justify-between px-16 items-center">
            <HomeIcon size={40} className="text-black fill-black cursor-pointer" onClick={() => navigate('/')} />
            <User size={40} strokeWidth={3} className="text-black cursor-pointer" onClick={() => navigate('/profile')} />
        </div>
